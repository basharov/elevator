...
/* harmony export */   "ElevatorConfig": () => (/* binding */ ElevatorConfig),
/* harmony export */   "DirectionsLabels": () => (/* binding */ DirectionsLabels)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initElevatorController": () => (/* binding */ initElevatorController)
/* harmony export */ });
/* harmony import */ var _ElevatorMachine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _DataStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _utils_sleep__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);





const initElevatorController = async (config) => {
    const storage = (0,_DataStorage__WEBPACK_IMPORTED_MODULE_1__.initElevatorControllerDataStorage)();
    const elevatorMachine = await (0,_ElevatorMachine__WEBPACK_IMPORTED_MODULE_0__.initElevatorMachine)(config);
    const eventListeners = {};
    const onServedAll = (cb) => {
        eventListeners.onServedAll = cb;
    };
    const onLoggableEvent = (cb) => {
        eventListeners.onLoggableEvent = cb;
    };
    const onBeforeFloor = (cb) => {
        eventListeners.onBeforeFloor = cb;
    };
    const addPersonToAwaitingList = (person) => {
        let destinationFloor = -1;
        if ((person.startFloor === 0 && person.direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down) || (person.startFloor === config.floorsCount && person.direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up)) {
        ...
        if (person.direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up) {
            destinationFloor = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.random)(person.startFloor + 1, config.floorsCount - 1);
        }
        else if (person.direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down) {
            destinationFloor = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.random)(0, person.startFloor - 1);
        }
    ...
    const getNextDirection = () => {
        ...
        if (storage.personsInCabin.length === 0 && storage.personsAwaiting.length === 0) {
            ...
            return _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.None;
        }
        const cabinFloor = elevatorMachine.getCurrentFloor();
        const [floorsBelow, floorsAbove] = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.partition)(storage.personsAwaiting, (person => person.startFloor < cabinFloor));
        const floorsBelowOrdered = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.orderBy)(floorsBelow, ['startFloor'], ['desc']);
        const floorsAboveOrdered = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.orderBy)(floorsAbove, ['startFloor'], ['asc']);
        ...
        return distanceToAboveFloor <= distanceToBelowFloor ? _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up : _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down;
    };
    const unloadCabin = async () => {
        ...
        await (0,_utils_sleep__WEBPACK_IMPORTED_MODULE_4__.sleep)(1000 / config.speed);
    ...
    const loadCabin = async () => {
        ...
        if (storage.personsInCabin.length > 0) {
            ...
            const directions = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.partition)(personsToLoad, (person => person.direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up));
    ...
    const processQueue = async () => {
        ...
        await (0,_utils_sleep__WEBPACK_IMPORTED_MODULE_4__.sleep)(1000 / config.speed);
        if (nextDirection === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up) {
            eventListeners.onLoggableEvent && eventListeners.onLoggableEvent('moving');
            elevatorMachine.moveUp();
        }
        else if (nextDirection === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down) {
            eventListeners.onLoggableEvent && eventListeners.onLoggableEvent('moving');
            elevatorMachine.moveDown();
        }
    };
    const personsAwaitingOnTheFloor = (floorNumber) => {
    ...
    elevatorMachine.onBeforeFloor && elevatorMachine.onBeforeFloor((floorNumber) => {
    ...
    elevatorMachine.onFloorButtonPressed && elevatorMachine.onFloorButtonPressed((currentFloor, direction) => {
    ...
    const addRandomPersonsToAwaitingList = (count = 1000) => {
        while (storage.personsAwaiting.length < count) {
            const direction = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.sample)([_types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up, _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down]);
            const startFloor = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.random)(direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Down ? 1 : 0, direction === _types__WEBPACK_IMPORTED_MODULE_2__.CabinDirection.Up ? config.floorsCount - 2 : config.floorsCount - 1);
            const person = {
                startFloor,
                direction,
            };
    ...
    const pressCabinButton = (floorNumber) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initElevatorMachine": () => (/* binding */ initElevatorMachine)
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/* harmony import */ var _services_DataStorage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _utils_sleep__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);



const initElevatorMachine = async (config) => {
    window.config = config;
    const machineStorage = (0,_services_DataStorage__WEBPACK_IMPORTED_MODULE_1__.initElevatorMachineDataStorage)(config);
    const eventListeners = {};
    const onBeforeFloor = (cb) => {
        eventListeners.onBeforeFloor = cb;
    };
    const onDoorsOpened = (cb) => {
        eventListeners.onDoorsOpened = cb;
    };
    const onFloorButtonPressed = (cb) => {
    ...
    const move = async (direction) => {
        if (!machineStorage.stop) {
            ...
            clearTimeout(machineStorage.moveTimeout);
            machineStorage.stop = false;
        }
    };
    const startMovingInDirection = async (direction) => {
        await (0,_utils_sleep__WEBPACK_IMPORTED_MODULE_2__.sleep)(1000 / config.speed);
        console.log('Closing doors...');
        eventListeners.onDoorsClosed && eventListeners.onDoorsClosed();
        console.log('Start moving...');
        machineStorage.currentDirection = direction;
        if (machineStorage.currentDirection === _types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Up && getCurrentFloor() >= config.floorsCount - 1) {
            return move(_types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Down);
        }
        if (machineStorage.currentDirection === _types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Down && getCurrentFloor() <= 0) {
            return move(_types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Up);
        }
        return move(direction);
    };
    const moveUp = async () => startMovingInDirection(_types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Up);
    const moveDown = async () => startMovingInDirection(_types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.Down);
    ...
    const stopAndOpenDoors = async () => {
        ...
        machineStorage.currentDirection = _types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.None;
        eventListeners.onDoorsOpened && eventListeners.onDoorsOpened();
    };
    const pressFloorButton = (floorNumber, direction) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CabinDirection": () => (/* binding */ CabinDirection)
/* harmony export */ });
var CabinDirection;
(function (CabinDirection) {
    CabinDirection[CabinDirection["Down"] = -1] = "Down";
    CabinDirection[CabinDirection["None"] = 0] = "None";
    CabinDirection[CabinDirection["Up"] = 1] = "Up";
})(CabinDirection || (CabinDirection = {}));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initElevatorControllerDataStorage": () => (/* binding */ initElevatorControllerDataStorage),
/* harmony export */   "initElevatorMachineDataStorage": () => (/* binding */ initElevatorMachineDataStorage)
/* harmony export */ });
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);

const initElevatorControllerDataStorage = () => ({
    personsAwaiting: [],
    personsInCabin: [],
});
const initElevatorMachineDataStorage = (config) => ({
    currentFloor: config.startFloor,
    currentDirection: _types__WEBPACK_IMPORTED_MODULE_0__.CabinDirection.None,
    stop: false,
});
...
/* harmony import */ var _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var _services_ElevatorController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _services_types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
const createBuilding = () => {
    ...
    for (let i = 0; i < _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.floorsCount; i += 1) {
...
const populatePersonsAwaiting = (persons) => {
    const rows = document.querySelectorAll('.floorRow');
    rows.forEach((el, index) => {
        const personsFiltered = persons.filter(person => person.startFloor === index);
        let value = '';
        personsFiltered.forEach((person) => {
            value += `<div class="person ${_services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.DirectionsLabels[person.direction]}"></div>`;
        });
        el.innerHTML = value;
    });
};
const createCabin = () => {
    ...
    cabin.style.transform = `translateY(-${_services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.startFloor * 60}px)`;
    building?.appendChild(cabin);
    window.elevatorController.onBeforeFloor && window.elevatorController.onBeforeFloor((floorNumber) => {
...
const updateDestinationFloors = () => {
    const floorIndicators = document.querySelectorAll('.floorIndicator');
    const personsInCabin = window.elevatorController.getPersonsInCabin();
    const destinationFloors = personsInCabin.reduce((accum, person) => {
...
const createFloorControls = () => {
    ...
    for (let i = 0; i < _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.floorsCount; i += 1) {
        ...
        else if (i === _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.floorsCount - 1) {
...
const populateCabin = () => {
    const personsInCabin = window.elevatorController.getPersonsInCabin();
    const cabinCountElement = document.querySelector('.cabinLabel');
...
const populateDataPanel = () => {
    ...
    const personsInCabin = window.elevatorController.getPersonsInCabin();
    const personsAwaitingElement = document.querySelector('#dataPanel .personsAwaiting');
    const personsInCabinElement = document.querySelector('#dataPanel .cabinValue');
...
const createControlPanel = () => {
    ...
    generatePersonsAwaitingButton?.addEventListener('click', () => {
        const personsToGenerateInput = document.querySelector('#personsToGenerate');
    ...
    speedControl?.addEventListener('change', async (event) => {
        window.config.speed = Number(event.currentTarget?.value);
    });
    const generateRandomFloorButton = () => {
        const direction = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.sample)([_services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Up, _services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Down]);
        const startFloor = (0,lodash__WEBPACK_IMPORTED_MODULE_3__.random)(direction === _services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Down ? 1 : 0, direction === _services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Up ? _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.floorsCount - 2 : _services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig.floorsCount - 1);
    ...
    randomFloorPressButton?.addEventListener('click', async () => {
        setInterval(() => {
            ...
            populateCabin();
        }, (0,lodash__WEBPACK_IMPORTED_MODULE_3__.random)(0, 300));
    });
};
const bindFloorButtons = () => {
    const upButtons = document.querySelectorAll('.moveUpButton');
    const downButtons = document.querySelectorAll('.moveDownButton');
    upButtons.forEach((button) => {
        button.addEventListener('click', () => {
            const floor = Number(button.getAttribute('data-floor'));
            window.elevatorController.pressFloorButton(floor, _services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Up);
            const personsWaiting = window.elevatorController.getPersonsAwaiting();
            populatePersonsAwaiting(personsWaiting);
            populateDataPanel();
        });
    ...
    downButtons.forEach((button) => {
        button.addEventListener('click', () => {
            const floor = Number(button.getAttribute('data-floor'));
            window.elevatorController.pressFloorButton(floor, _services_types__WEBPACK_IMPORTED_MODULE_4__.CabinDirection.Down);
            const personsWaiting = window.elevatorController.getPersonsAwaiting();
            populatePersonsAwaiting(personsWaiting);
            populateDataPanel();
        });
...
const bindControllerEvents = () => {
    ...
    window.elevatorController.onLoggableEvent && window.elevatorController.onLoggableEvent((eventLabel) => {
...
const initElevatorInterface = async () => {
    window.elevatorController = await (0,_services_ElevatorController__WEBPACK_IMPORTED_MODULE_2__.initElevatorController)(_services_ElevatorConfig__WEBPACK_IMPORTED_MODULE_1__.ElevatorConfig);
};
const init = async () => {
